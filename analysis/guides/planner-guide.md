...
**When to use:**
- [DONE] Gate passing (precision alignment critical)
- [DONE] Torpedo firing (must be stationary)
- [DONE] Multi-step manipulation tasks
...
|-------|-------------|---------|-------|
| `SubmergeState` | [DONE] | [DONE] | Waits for stable depth |
| `SearchState` | | | Continuous rotation |
| `AlignState` | [DONE] | [DONE] | Vision servoing benefits from stability |
| `DriveState` | [DONE] | [DONE] | Full V2 benefit - precise drive-through |
| `DemoLegState` | [DONE] | [DONE] | Square pattern precision |
| `DemoTurnState` | [DONE] | [DONE] | Sharp 90° turns |
| `SurfaceState` | [DONE] | | Waits for surface arrival |
