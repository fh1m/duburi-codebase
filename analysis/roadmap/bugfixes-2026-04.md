...
> **Build Status:** [DONE] PASSING (4.10s)

---

## CRITICAL CRITICAL Issues (Must Fix Before Pool Testing)

### [DONE] #2 RC Override Not Continuous [RESOLVED]
...
### [DONE] #3 Depth from AHRS2.altitude is MSL Altitude [FIXED]
- **Status:** [DONE] COMPLETED
- **Category:** MAVLink
...
- **Agent:** `fix-depth-computation` [DONE]
- **Code:**
 ```python
...
### [DONE] #4 IMU Velocity Integration Ignores Gravity Rotation [FIXED]
- **Status:** [DONE] COMPLETED
...
- **Agent:** `fix-gravity-compensation` [DONE]
- **Build:** [DONE] SUCCESS

### [DONE] #5 Thread Safety: _ramped Dict Not Locked [FIXED]
- **Status:** [DONE] COMPLETED
- **Category:** Threading
...
- **Agent:** `fix-rc-thread-safety` [DONE]
- **Build:** [DONE] SUCCESS

### [DONE] #6 CH_THROTTLE Neutral Causes Depth Oscillation [QUEUED]
- **Status:** [MEDIUM] QUEUED
- **Category:** Design
...
### [DONE] #7 PID Derivative Kick on Setpoint Change [VERIFIED ALREADY FIXED]
- **Status:** [DONE] COMPLETED
- **Category:** PID
...
- **Verification:** All 5 callers pass `measurement_rate` correctly [DONE]
- **Agent:** `fix-pid-derivative` [DONE]

### [DONE] #8 MAV_FRAME_GLOBAL_INT Wrong for Depth [QUEUED]
- **Status:** [MEDIUM] QUEUED
- **Category:** MAVLink
...
### [DONE] #9 CascadeController Shares Integral State [QUEUED]
- **Status:** [MEDIUM] QUEUED
- **Category:** Design
...
### [IN PROGRESS] #10 SCALED_IMU2 Gravity Not Subtracted [QUEUED]
- **Status:** [MEDIUM] QUEUED
- **Category:** MAVLink/IMU
...
|---|-------|------|--------|-------|
| 11 | DVL bottom_lock from variance | sensor_sources.py:274 | [MEDIUM] QUEUED | `fix-dvl-bottom-lock` |
| 12 | No source_system specified | connection_manager.py:234 | [MEDIUM] QUEUED | `fix-source-system` |
| 13 | Blocking wait in ROS callback | mission_executor.py:85 | [MEDIUM] QUEUED | `fix-blocking-wait` |
| 14 | V2 features disabled by default | defaults.yaml | [MEDIUM] QUEUED | `add-v2-docs` |
| 15 | wait_for_ready blocks constructor | planner_context.py:95 | [MEDIUM] QUEUED | `fix-planner-blocking` |
| 16 | Trailing slash inconsistent | blueos_api.py:275 | [MEDIUM] QUEUED | `fix-blueos-api` |
| 17 | Fixed dt=0.05s in yaw loop | command_handler.py:510 | [MEDIUM] QUEUED | `fix-yaw-dt` |
| 18 | ZUPT threshold too low | velocity_control.py:105 | [MEDIUM] QUEUED | `fix-zupt-threshold` |
| 19 | Ramp decel fights braking | rc_controller.py:200 | [MEDIUM] QUEUED | `fix-decel-brake` |
| 20 | SET_ATTITUDE_TARGET convention | inspector_node.py:1048 | [MEDIUM] QUEUED | `verify-quaternion` |
...
|---|-------|----------|--------|
| 21 | Variable name unclear | Typo | [MEDIUM] QUEUED |
| 22 | CommandSpec too large | Style | [MEDIUM] QUEUED |
| 23 | Missing speed param docs | Docs | [MEDIUM] QUEUED |
| 24 | State log interval not configurable | Design | [MEDIUM] QUEUED |
| 25 | DEFAULT_SPEED unclear units | Naming | [MEDIUM] QUEUED |
| 26 | DuburiClient inconsistent | Design | [MEDIUM] QUEUED |
